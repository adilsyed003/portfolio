        ...
        <div>
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700">
                ...
                <div className="p-5">
                    ...
                    <a href="https://github.com/adilsyed003" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-sky-400 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-sky-400 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        View project
                    </a>
                </div>
            </div>
